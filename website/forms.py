...
class SignUpForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['password1'].help_text = '<ul class form-text text-muted small><li>Your password cannot be too similar to your other personal information</li><li>Your password must contain at least 8 characters.</li><li>Your password cannot be commonly used password.</li><li>Your password cannot be entirely numeric.</li></ul>'
